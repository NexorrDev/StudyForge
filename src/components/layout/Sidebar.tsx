...
export function Sidebar() {
  ...
  return (
    <aside style={{ position:"fixed", left:0, top:0, width:220, height:"100vh", background:"var(--bg-deep)", borderRight:"1px solid var(--border)", display:"flex", flexDirection:"column", padding:16, zIndex:50, overflow:"hidden" }}>
      <Link href="/dashboard" style={{ display:"flex", alignItems:"center", gap:10, marginBottom:32, paddingLeft:4, textDecoration:"none", minWidth:0 }}>
        <div style={{ width:32, height:32, borderRadius:10, flexShrink:0, background:"linear-gradient(135deg,var(--primary),var(--cyan))", boxShadow:"0 4px 16px var(--primary-glow)", display:"flex", alignItems:"center", justifyContent:"center", fontSize:16 }}>🧠</div>
        <span style={{ fontFamily:"var(--font-syne,sans-serif)", fontWeight:800, fontSize:16, color:"var(--text-primary)", overflow:"hidden", textOverflow:"ellipsis", whiteSpace:"nowrap" }}>StudyForge</span>
      </Link>
      ...
      <div style={{ borderTop:"1px solid var(--border)", paddingTop:12, marginTop:8, minWidth:0 }}>
        <div style={{ display:"flex", alignItems:"center", gap:8, padding:"8px 10px", borderRadius:12, marginBottom:8, minWidth:0 }}>
