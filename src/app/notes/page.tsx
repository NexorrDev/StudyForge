            ...
            {notes.map(note => (
              <div key={note.id} style={{ display:"flex", justifyContent:"space-between", alignItems:"center", padding:"16px 20px", borderRadius:16, border:"1px solid var(--border)", background:"var(--bg-card)", transition:"all 0.2s" }}
                ...
                <div style={{ display:"flex", alignItems:"center", gap:10, marginLeft:16, flexShrink:0 }}>
                  ...
                  <Link href={"/notes/"+note.id} style={{ padding:"6px 12px", borderRadius:8, border:"1px solid var(--border)", background:"transparent", color:"var(--text-secondary)", textDecoration:"none", fontSize:12, fontWeight:600 }}>Ouvrir</Link>
